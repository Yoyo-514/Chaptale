import blueprintSource from './blueprint.md?raw';
...
import plotReviewerSource from './plot-reviewer.md?raw';
import rewriterSource from './rewriter.md?raw';
...
export const builtinPersonaSources: readonly string[] = [
  blueprintSource.replace(/\r\n/g, '\n'),
  plotReviewerSource.replace(/\r\n/g, '\n'),
