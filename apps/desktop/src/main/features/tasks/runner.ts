...
import { resolveTaskSpec } from '../personas/task-spec';
import type { AgentRunRecord } from '../runs/record';
...
export class TaskRunner implements TaskRunnerPort {
  constructor(
    private readonly sessionFactory: TaskSessionFactoryPort<TaskSession>,
