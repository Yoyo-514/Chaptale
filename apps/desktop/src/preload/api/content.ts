...
export function createContentApi(): ContentApi {
  return {
    ...
    restore: args => ipcRenderer.invoke(IPC_CHANNELS.content.restore, args),
    previewDelete: args => ipcRenderer.invoke(IPC_CHANNELS.content.previewDelete, args),
    delete: args => ipcRenderer.invoke(IPC_CHANNELS.content.delete, args),
